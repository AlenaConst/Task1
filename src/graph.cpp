...
graph::graph(int n,int* m):numb(n),ms(new int[n*n])
{
    int i;
...
{   p.assign(nn*nn,-1);
    ...
    {
        line(300+(int)round(200*cos(2*pi*v[i]/nn)),250+(int)round(200*sin(2*pi*v[i]/nn)),300+(int)round(200*cos(2*pi*v[i+1]/nn)),250+(int)round(200*sin(2*pi*v[i+1]/nn)));
    }
    readkey();
